...
QT_MOC_LITERAL(6, 71, 21), // "QPersistentModelIndex"
QT_MOC_LITERAL(7, 93, 6), // "_index"
QT_MOC_LITERAL(8, 100, 12) // "deleteSignal"

    },
    "WalletGUI::AddressBookDelegate\0"
    "sendToSignal\0\0_address\0label\0editSignal\0"
    "QPersistentModelIndex\0_index\0deleteSignal"
};
...
void WalletGUI::AddressBookDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddressBookDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddressBookDelegate::*)(const QString & , const QString & ) const;
        ...
        {
            using _t = void (AddressBookDelegate::*)(const QPersistentModelIndex & ) const;
...
QT_INIT_METAOBJECT const QMetaObject WalletGUI::AddressBookDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_WalletGUI__AddressBookDelegate.data,
    qt_meta_data_WalletGUI__AddressBookDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
