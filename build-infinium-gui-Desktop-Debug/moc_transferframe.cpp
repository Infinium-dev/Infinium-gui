...
void WalletGUI::TransferFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TransferFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TransferFrame::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransferFrame::amountStringChangedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TransferFrame::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransferFrame::addressChangedSignal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WalletGUI::TransferFrame::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_WalletGUI__TransferFrame.data,
    qt_meta_data_WalletGUI__TransferFrame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
