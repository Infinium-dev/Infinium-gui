...
QT_MOC_LITERAL(8, 145, 24), // "beginRemoveAddressSignal"
QT_MOC_LITERAL(9, 170, 22) // "endRemoveAddressSignal"
    ...
    "addressEditedSignal\0beginRemoveAddressSignal\0"
    "endRemoveAddressSignal"
};
...
void WalletGUI::AddressBookManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddressBookManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 4: _t->beginRemoveAddressSignal((*reinterpret_cast< AddressIndex(*)>(_a[1]))); break;
        case 5: _t->endRemoveAddressSignal(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AddressBookManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::addressBookOpenedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AddressBookManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::addressBookClosedSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AddressBookManager::*)(AddressIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::addressAddedSignal)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (AddressBookManager::*)(AddressIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::addressEditedSignal)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (AddressBookManager::*)(AddressIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::beginRemoveAddressSignal)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (AddressBookManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressBookManager::endRemoveAddressSignal)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WalletGUI::AddressBookManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_WalletGUI__AddressBookManager.data,
    qt_meta_data_WalletGUI__AddressBookManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 4
void WalletGUI::AddressBookManager::beginRemoveAddressSignal(AddressIndex _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void WalletGUI::AddressBookManager::endRemoveAddressSignal()
{
