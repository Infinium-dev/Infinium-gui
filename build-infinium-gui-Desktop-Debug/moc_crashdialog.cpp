...
void WalletGUI::CrashDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CrashDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WalletGUI::CrashDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_WalletGUI__CrashDialog.data,
    qt_meta_data_WalletGUI__CrashDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
