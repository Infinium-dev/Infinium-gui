...
void WalletGUI::StratumClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StratumClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (StratumClient::*)(quint32 );
        ...
        {
            using _t = void (StratumClient::*)(const QDateTime & );
...
QT_INIT_METAOBJECT const QMetaObject WalletGUI::StratumClient::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_WalletGUI__StratumClient.data,
    qt_meta_data_WalletGUI__StratumClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
